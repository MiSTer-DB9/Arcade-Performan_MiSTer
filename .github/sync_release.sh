...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Performan_MiSTer.git"
CORE_NAME=(Arcade-Performan)
...
UPSTREAM_CORE_NAME=(Arcade-Performan)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Performan.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Performan.rbf)
